          ...
          timeCatalog.map(function (c, i) {
            return (
              <div
                key={"div-" + c.name}
                className={
                  `min-w-[250px] h-[350px] border-yellow-500 m-2 bg-slate-900 p-2 rounded-lg flex flex-col items-center justify-between text-center musicitem ${`animate-[fadein_1s_ease-in-out_${0.1 + i/10}s]`}`
                }
              >
